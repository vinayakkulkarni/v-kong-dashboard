<template>
  <div class="sticky top-0 z-10 flex h-16 flex-shrink-0 shadow">
    <button
      type="button"
      class="border-r dark:border-b border-gray-200 dark:border-gray-700 px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-violet-500 md:hidden"
    ...
    <div
      class="flex flex-1 justify-between px-4 dark:border-b dark:border-gray-700"
    >
      <div class="flex flex-1">
        <form class="flex w-full md:ml-0" action="#" method="GET">
          <label for="search-field" class="sr-only">Search</label>
          <div
            class="relative w-full focus-within:text-gray-600 dark:focus-within:text-gray-300"
          >
            <div
            ...
            <input
              id="search-field"
              class="block bg-transparent h-full w-full border-transparent py-2 pl-8 pr-3 dark:placeholder-gray-300 placeholder-gray-500 focus:border-transparent focus:placeholder-gray-400 focus:outline-none focus:ring-0 sm:text-sm"
              placeholder="Search"
              type="search"
              name="search"
            />
      ...
      <div class="ml-4 flex items-center md:ml-6">
        <button
          type="button"
          class="rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2"
          @click="toggleDark()"
        >
          <svg
            v-if="!isDark"
        ...
        <button
          type="button"
          class="ml-3 rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2"
        >
        ...
        <div class="relative ml-3">
          ...
          >
            <div
              ...
              class="absolute bg-gray-50 dark:bg-gray-700 right-0 z-10 mt-2 w-48 origin-top-right rounded-md py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
              role="menu"
